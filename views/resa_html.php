    ...
    foreach ($resas as $resa) {
      ...
      if ( count($days) > 2 ) {
        ...
        <tr id="tr-day-<?= $days[0]->id ?>" style="background: <?php echo $color ?>">
          ...
          <td style="border-top: 1px solid black;"><button class="edit-day" id="day-<?= $days[0]->id ?>">Modifier ce jour</button></td>
          <td style="border-top: 1px solid black;">
            <form action="#" method="post">
              ...
              <input type="submit" name="add_day[0]" value="Ajouter <?= $day_before ?>">
            </form>
          </td>
          <td style="border-top: 1px solid black;">
            <form action="#" method="post">
        ...
        for ($i=1; $i < count($days)-1 ; $i++) { ?>
          <tr id="tr-day-<?= $days[$i]->id ?>" style="background: <?php echo $color ?>">
            ...
            <td><button class="edit-day" id="day-<?= $days[$i]->id ?>">Modifier ce jour</button></td>
            <td></td>
            <td></td>
          </tr><?php
        } ?>
        <tr id="tr-day-<?= $days[count($days)-1]->id ?>" style="background: <?php echo $color ?>">
          ...
          <td><button class="edit-day" id="day-<?= $days[count($days)-1]->id ?>">Modifier ce jour</button></td>
          <td>
            <form action="#" method="post">
              <input type="hidden" name="resa_id[0]" value="<?php echo $resa->id ?>">
              ...
              <input type="submit" name="add_day[0]" value="Ajouter <?= $day_after ?>">
            </form>
          </td>
          <td style="border-top: 1px solid black;">
            <form action="#" method="post">
        ...
        <tr id="tr-day-<?= $days[1]->id ?>" style="background: <?php echo $color ?>">
          ...
          <td><button class="edit-day" id="day-<?= $days[1]->id ?>">Modifier ce jour</button></td>
          <td>
            <form action="#" method="post">
              <input type="hidden" name="resa_id[0]" value="<?php echo $resa->id ?>">
        ...
        <tr id="tr-day-<?= $days[0]->id ?>" style="background: <?php echo $color ?>">
          ...
          <td><button class="edit-day" id="day-<?= $days[0]->id ?>">Modifier ce jour</button></td>
          <td>
            <form action="#" method="post">
              <input type="hidden" name="resa_id[0]" value="<?php echo $resa->id ?>">
              <input type="hidden" name="dinner[0]" value="<?php echo $days[0]->dinner ?>">
