      ...
      foreach ($resas as $resa) {
        ...
        if ( count($days) > 2 ) {
          ...
          <tr id="tr-day-<?= $days[0]->id ?>" style="background: <?php echo $color ?>">
            ...
            <td style="border-top: 1px solid black;"><button class="icon-btn edit-day" id="day-<?= $days[0]->id ?>"><i class="far fa-edit"></button></td>
            <td style="border-top: 1px solid black;">
          ...
          for ($i=1; $i < count($days)-1 ; $i++) { ?>
            <tr id="tr-day-<?= $days[$i]->id ?>" style="background: <?php echo $color ?>">
              ...
              <td><button class="icon-btn edit-day" id="day-<?= $days[$i]->id ?>"><i class="far fa-edit"></button></td>
              <td></td>
              <td></td>
            </tr><?php
          } ?>
          <tr id="tr-day-<?= $days[count($days)-1]->id ?>" style="background: <?php echo $color ?>">
            ...
            <td><button class="icon-btn edit-day" id="day-<?= $days[count($days)-1]->id ?>"><i class="far fa-edit"></button></td>
            <td>
              <form action="#" method="post">
                <input type="hidden" name="resa_id[0]" value="<?php echo $resa->id ?>">
